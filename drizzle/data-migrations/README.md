...
- `backfill-ranked-deck-observations.ts`: copies still-retained ranked deck snapshots into the durable, rarity-normalized season environment facts. Follow `drizzle/migration-notes/ranked-season-environment.md`; apply requires a stopped ranked writer, a verified backup, a blocker-free dry-run, and the reviewed season ledger revision.
