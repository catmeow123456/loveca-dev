...
| `src/application/effects/member-state.ts` | `S01,S02,S05,S07` | 提供 `setMemberOrientation` / `setMembersOrientation`、`moveMemberBetweenSlots` 与 `playMembersFromWaitingRoomToEmptySlots`。`moveMemberBetweenSlots` 会记录成员区位置移动；普通拖拽在 action handler 侧同步记录。普通规则横置/拖拽仍在 GameSession/action handler。 | `PL!N-pb1-004` 费用 11「朝香果林」、`PL!SP-bp4-008` 费用 13「若菜四季」、`PL!SP-bp5-003` 费用 17「岚 千砂都」、`PL!N-pb1-008` 费用 17「艾玛·维尔德」、`PL!S-bp2-006` 费用 11「津岛善子」、`PL!HS-bp1-002` 费用 11「村野沙耶香」、`PL!HS-bp6-004` 费用 13「百生 吟子」 |
