...
| `src/application/effects/cheer-selection.ts`                                                                                                                 | `F14,F15`                             | 同时区分“当前仍可移动的声援卡”与 event-inclusive“本次曾公开事实”。移动路径支持手牌、卡组顶、卡组底、休息室与多选上限；纯 query 支持卡型/团体/事件范围、不同名、不同卡有效判心 Heart 覆盖，以及结构化 Blade Heart 的 Heart 色种收集。022 的不同卡匹配读取 `getCheerCardEffectiveBladeHearts`，不把成员印刷 `hearts` 混入，并反映本次 LIVE 的声援 Heart 颜色替换；Blade Heart 色种收集 query 可限制允许颜色，始终排除 DRAW/SCORE，已移出 resolution zone 的本次公开卡仍计入条件。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `PL!HS-bp6-001` 费用 4「日野下花帆」、`PL!HS-cl1-009` 分数 1「水彩世界」、`PL!HS-bp6-027` 分数 5「月夜見海月」、`PL!S-bp2-021` 分数 4「未体験HORIZON」、`PL!N-bp5-001` 费用5「上原歩夢」、`PL!N-bp7-025-SECL` 分数1「Colorful Dreams! Colorful Smiles!」、`PL!S-bp7-022-SECL` 分数8「想在水族馆恋爱」                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
