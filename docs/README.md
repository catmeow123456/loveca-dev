...
| 联机模式       | [专题索引](online-mode/README.md)、[准备文档](online-mode/preparation.md)、[快捷表情需求与设计](online-mode/match-emote-requirements-design.md)、[边界规范](online-mode/boundary-standard.md)、[远程撤销恢复实施记录与剩余计划](online-mode/remote-undo-requirements-design.md)                                                                                                                                                                                                       | 联机首版能力、局内通信、玩家视角投影、自由拖拽、运行期同步、远程撤销恢复和编码边界              |
| 赛季排位       | [首版当前状态与上线边界](matchmaking-and-ladder/RANKED_INITIAL_IMPLEMENTATION.md)、[数据与结算设计](matchmaking-and-ladder/RANKED_R2_DATA_AND_SETTLEMENT_DESIGN.md)、[管理员 API](matchmaking-and-ladder/RANKED_ADMIN_API.md)、[活动赛季 V2→V3 停机迁移](matchmaking-and-ladder/RANKED_V3_ACTIVE_SEASON_MIGRATION.md)、[影子报告分析](matchmaking-and-ladder/RANKED_SHADOW_REPORT_ANALYSIS_2026-07-30.md)、[影子报告运行说明](matchmaking-and-ladder/RANKED_SHADOW_REPORT_RUNBOOK.md) | 赛季生命周期、固定时段候场、Glicko 结算与重建、玩家/管理员边界、上线前置与影子参数判断          |
