...
| 赛季排位       | [专题索引](matchmaking-and-ladder/README.md)、[首版当前状态与上线边界](matchmaking-and-ladder/RANKED_INITIAL_IMPLEMENTATION.md)、[数据与结算设计](matchmaking-and-ladder/RANKED_R2_DATA_AND_SETTLEMENT_DESIGN.md)、[V4 评分设计](matchmaking-and-ladder/RANKED_V4_RATING_DESIGN.md)、[评分参数修订与全量回算](matchmaking-and-ladder/RANKED_RATING_PARAMETER_REVISION.md)、[管理员 API](matchmaking-and-ladder/RANKED_ADMIN_API.md)、[历史 V2→V3 停机迁移](matchmaking-and-ladder/RANKED_V3_ACTIVE_SEASON_MIGRATION.md)、[影子报告分析](matchmaking-and-ladder/RANKED_SHADOW_REPORT_ANALYSIS_2026-07-30.md)、[影子报告运行说明](matchmaking-and-ladder/RANKED_SHADOW_REPORT_RUNBOOK.md) | 赛季生命周期、固定时段候场、Glicko 与成长池结算、参数修订、全量重建、玩家/管理员边界、卡组环境调研及历史迁移说明 |
