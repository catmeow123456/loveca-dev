...
```bash
DATABASE_URL=postgresql://... pnpm exec tsx drizzle/data-migrations/3.5.0-to-3.6.0-compress-match-replay-checkpoints.ts --dry-run --report=tmp/replay-checkpoint-compress-dry-run.json
