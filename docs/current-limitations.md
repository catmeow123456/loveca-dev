...
当前正式联机已经具备基础闭环：房间创建/加入、云端卡组锁定、双方准备开始、开局猜拳与胜者决定先后手、服务端权威对局、轮询同步、主动认输、房间号观战跨重开等待与自动续看、离开/短暂恢复、局内文字聊天和管理员房间观测。局内聊天允许对局双方发送、已授权观战者只读，并支持刷新或短暂断线后的游标补拉。公共牌桌 Beta 已提供持久候场、FIFO 配对、双方确认、60 秒双方到场确认、封闭房间引导和跨页面候场状态；其对局复用正式联机运行链路。
