...
const TOKEN_DEFINITIONS = new Map<string, Omit<CardEffectPlaceholderPart, 'raw'>>([
  ...
  ['【每回合2次】', { kind: 'limit', label: '每回合2次' }],
  ['【ターン3回】', { kind: 'limit', label: 'ターン3回' }],
  ['【ターン３回】', { kind: 'limit', label: 'ターン３回' }],
  ['【1回合3次】', { kind: 'limit', label: '1回合3次' }],
  ['【每回合3次】', { kind: 'limit', label: '每回合3次' }],
  ...
  ['[ALLBLADE]', { kind: 'blade', label: 'ALLBLADE', icon: 'blade_heart_all' }],
  ['[ブレード]', { kind: 'blade', label: 'ブレード', icon: 'blade' }],
  ['[ALLブレード]', { kind: 'blade', label: 'ALLブレード', icon: 'blade_heart_all' }],
  ['[桃ブレード]', { kind: 'blade', label: '桃ブレード', icon: 'blade_heart_pink' }],
  ['[赤ブレード]', { kind: 'blade', label: '赤ブレード', icon: 'blade_heart_red' }],
  ['[黄ブレード]', { kind: 'blade', label: '黄ブレード', icon: 'blade_heart_yellow' }],
  ['[緑ブレード]', { kind: 'blade', label: '緑ブレード', icon: 'blade_heart_green' }],
  ['[青ブレード]', { kind: 'blade', label: '青ブレード', icon: 'blade_heart_blue' }],
  ['[紫ブレード]', { kind: 'blade', label: '紫ブレード', icon: 'blade_heart_purple' }],
  ['[オレンジブレード]', { kind: 'blade', label: 'オレンジブレード', icon: 'heart_orange' }],
  ...
  ['[オレンジハート]', { kind: 'heart', label: 'オレンジハート', icon: 'heart_orange' }],
  ['[橙ハート]', { kind: 'heart', label: '橙ハート', icon: 'heart_orange' }],
  ['[橙HEART]', { kind: 'heart', label: '橙HEART', icon: 'heart_orange' }],
