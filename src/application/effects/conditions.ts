...
import { successLiveScoreAtLeast as domainSuccessLiveScoreAtLeast } from '../../domain/rules/success-live-score.js';
export {
...
function isBp4008HanayoStageCostBonusActive(
  ...
  return domainSuccessLiveScoreAtLeast(game, playerId, 6);
}
