...
const PL_N_BP1_001_LIVE_START_PAY_ENERGY_STEP_ID = 'PL_N_BP1_001_LIVE_START_PAY_ENERGY';
const N_SD2_004_LIVE_START_PAY_ENERGY_STEP_ID = 'N_SD2_004_LIVE_START_PAY_ENERGY';
const N_SD2_008_LIVE_START_PAY_ENERGY_STEP_ID = 'N_SD2_008_LIVE_START_PAY_ENERGY';
const LL_BP3_001_LIVE_START_PAY_ENERGY_STEP_ID = 'LL_BP3_001_LIVE_START_PAY_ENERGY';
...
const PAY_ENERGY_GAIN_BLADE_WORKFLOWS: readonly PayEnergyGainBladeWorkflowConfig[] = [
  {
    ...
    stepId: PL_N_BP1_001_LIVE_START_PAY_ENERGY_STEP_ID,
  ...
  },
  {
    ...
    stepId: LL_BP3_001_LIVE_START_PAY_ENERGY_STEP_ID,
    energyCost: { kind: 'FIXED', count: 6 },
    bladeBonusSource: { kind: 'FIXED', amount: 3 },
  },
];
...
function getStartStepText(
  ...
  return `可以支付${'[E]'.repeat(config.energyCost.count)}，获得${'[BLADE]'.repeat(startBladeBonus)}。`;
}
