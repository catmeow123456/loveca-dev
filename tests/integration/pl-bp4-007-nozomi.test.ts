...
import { PL_BP4_007_ON_ENTER_SUCCESS_LIVE_EXISTS_SCORE_AT_MOST_ONE_GAIN_SCORE_ABILITY_ID as ABILITY } from '../../src/application/card-effects/ability-ids';
...
function resolveOne(game: GameState, sourceCardId = 'nozomi'): GameState {
  return resolvePendingCardEffects({
    ...game,
    pendingAbilities: [pending('pending-007', sourceCardId)],
  }).gameState;
}
