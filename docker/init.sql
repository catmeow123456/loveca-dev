...
CREATE TABLE IF NOT EXISTS public.match_records (
  ...
  completeness TEXT NOT NULL DEFAULT 'FULL'
    CHECK (completeness IN ('FULL', 'PARTIAL', 'INCOMPLETE', 'METADATA_ONLY')),
...
CREATE TABLE IF NOT EXISTS public.match_decision_records (
  ...
  decision_type TEXT NOT NULL
    CONSTRAINT match_decision_records_type_check
    CHECK (decision_type IN ('ACTIVE_EFFECT_OPENED', 'ACTIVE_EFFECT_SUBMITTED', 'PENDING_ABILITY_ORDER_SUBMITTED', 'ACTIVATE_ABILITY_SUBMITTED', 'MULLIGAN_SUBMITTED', 'SET_LIVE_CARD_SUBMITTED', 'SELECT_SUCCESS_LIVE_SUBMITTED')),
